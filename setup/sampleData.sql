...
--
-- INSERT INTO category (name)  SELECT 'dairy' FROM dual UNION ALL  SELECT 'meats' FROM dual UNION ALL  SELECT 'bakery' FROM dual UNION ALL  SELECT 'fruit veg' FROM dual;

INSERT INTO category (id, name)  values (category_seq.nextval, 'dairy');
INSERT INTO category (id, name)  values (category_seq.nextval, 'meats');
INSERT INTO category (id, name)  values (category_seq.nextval, 'bakery');
INSERT INTO category (id, name)  values (category_seq.nextval, 'fruit veg');
...
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'milk', 1.70, 'semi skimmed (1L)', (select id from category where name = 'dairy'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'cheese', 2.39, 'mild cheddar (330g)',  (select id from category where name = 'dairy'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'butter', 1.09, 'unsalted (250g)',  (select id from category where name = 'dairy'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'free range eggs', 1.76, 'medium-sized (6 eggs)',  (select id from category where name = 'dairy'));

INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'organic meat patties', 2.29, 'rolled in fresh herbs<br>2 patties (250g)', (select id from category where name = 'meats'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'parma ham', 3.49, 'matured, organic (70g)', (select id from category where name = 'meats'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'chicken leg', 2.59, 'free range (250g)', (select id from category where name = 'meats'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'sausages', 3.55, 'reduced fat, pork<br>3 sausages (350g)', (select id from category where name = 'meats'));

INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'sunflower seed loaf', 1.89, '600g', (select id from category where name = 'bakery'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'sesame seed bagel', 1.19, '4 bagels', (select id from category where name = 'bakery'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'pumpkin seed bun', 1.15, '4 buns', (select id from category where name = 'bakery'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'chocolate cookies', 2.39, 'contain peanuts<br>(3 cookies)', (select id from category where name = 'bakery'));

INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'corn on the cob', 1.59, '2 pieces', (select id from category where name = 'fruit veg'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'red currants', 2.49, '150g', (select id from category where name = 'fruit veg'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'broccoli', 1.29, '500g', (select id from category where name = 'fruit veg'));
INSERT INTO product (id, name, price, description, category_id) VALUES (product_seq.nextval, 'seedless watermelon', 1.49, '250g', (select id from category where name = 'fruit veg'));
